...
Public Class CapturaService
    ...
    Public Function SaveAdvice(ByVal aobj_Advice As ClsAdviceMasterData, ByVal astr_userId As String) As List(Of ClsAdviceResult)
        ...
        Dim lobj_resultAdvicem As ClsAdviceResult = New ClsAdviceResult()
        ' de string  con inicio dia  a objeto fecha
        Try
        ...
        lobj_resultAdvicem.iint_AdviceId = 0
        lobj_resultAdvicem.iint_Succes = 0
        lobj_resultAdvicem.istrKeyToken = ""
        ...
        If lobj_resultAdvicem.iint_AdviceId = 0 Then
        ...
        End If
        '''' validar el booking 
        If lobj_resultAdvicem.istr_Message.Length > 0 Then
            ReDim lobj_list(0)
            lobj_list(0) = New ClsAdviceResult()
            lobj_list(0).iint_AdviceId = 0
            lobj_list(0).iint_Succes = 0
            lobj_list(0).istr_Container = ""
            lobj_list(0).istr_Message = lobj_resultAdvicem.istr_Message
            ...
            lobj_resultitem.iint_Succes = 0
            lobj_resultitem.istr_Container = ""
            lobj_resultitem.istr_Message = lobj_resultAdvicem.istr_Message
            llist_toReturn.Add(lobj_resultitem)
        ...
        Try
            lint_BookingAdvice = lobj_resultAdvicem.iint_AdviceId
        ...
        Catch ex As Exception
            ...
            lobj_list(0).iint_AdviceId = 0
            lobj_list(0).iint_Succes = 0
            lobj_list(0).istr_Message = "Error" + lobj_resultAdvicem.istr_Message
            'Return lobj_list
            ...
            lobj_resultitem.iint_Succes = 0
            lobj_resultitem.istr_Container = ""
            lobj_resultitem.istr_Message = "Error" + lobj_resultAdvicem.istr_Message
            llist_toReturn.Add(lobj_resultitem)
            Return llist_toReturn
        ...
        If aobj_Advice.iint_AdviceId = 0 Then
            ...
            If lobj_resultAdvicem.istr_Message > 0 Then
        ...
        If aobj_Advice.iobjs_ContainerList IsNot Nothing Then
            ...
            If aobj_Advice.iobjs_ContainerList.Count > 0 Then
                ...
                llist_tempresutl = of_saveDetailAdvice(aobj_Advice.iint_AdviceId, aobj_Advice.iobjs_ContainerList, astr_userId, lobj_resultAdvicem.istrKeyToken)
            ...
            Else
                ...
                If aobj_Advice.iint_AdviceId > 0 Then
                    ...
                    lobj_resultitem.istrKeyToken = lobj_resultAdvicem.istrKeyToken
        ...
        Else ' If aobj_Advice.iobjs_ContainerList Is Nothing Then
            ...
            If aobj_Advice.iint_AdviceId > 0 Then
                ...
                lobj_list(0).istrKeyToken = lobj_resultAdvicem.istrKeyToken
                ' Return ldtb_Table
                'Return lobj_list
    ...
    <WebMethod()>
    Public Function UpdateMasterAdviceV(ByVal aint_BookingAdviceId As Integer, ByVal astr_BookingId As String, ByVal aint_VesselId As Integer, ByVal alng_VesselVoyageId As Long, ByVal astr_PortId As String, ByVal astr_ETAtDate As String, ByVal aint_CustomerId As Integer, ByVal aint_CustomBrokerId As Integer, ByVal aint_ShippingLine As Integer, ByVal aint_ProductId As Integer, ByVal aint_IMOCode As Integer, ByVal aint_UNCode As Integer, ByVal astr_ServiceType As String, ByVal astr_AdviceComs As String, ByVal astr_ValidateStatus As String, ByVal astr_User As String, ByVal aintblnIsUniqueMerchType As Integer, aintInvoceToIdSO As Integer, aintInvoceToSOType As Integer, aintInvoceToIdDiscrp As Integer, aintInvoceToDiscType As Integer, aintInvoceToIdStorage As Integer, aintInvoceToStoraType As Integer) As String
    ...
    Public Function of_SaveMasterAdvice(ByVal aint_BookingAdviceId As Integer, ByVal astr_BookingId As String, ByVal astr_VesselName As String, ByVal astr_VoyageExpoId As String, ByVal aint_VesselId As String, ByVal alng_VesselVoyageId As Long, ByVal astr_PortText As String, ByVal astr_PortId As String, ByVal astr_CountryTxt As String, ByVal astr_CountryId As String, ByVal astr_ETAtDate As String, ByVal aint_CustomBrokerId As Integer, ByVal astr_ShippingLinetxt As String, ByVal aint_ShippingLine As Integer, ByVal astr_ProductText As String, ByVal aint_ProductId As Integer, ByVal aint_IMOCode As Integer, ByVal aint_UNCode As Integer, ByVal astr_ServiceType As String, ByVal astr_AdviceComs As String, ByVal astr_User As String, aintInvoceToIdSO As Integer, aintInvoceToSOType As Integer, aintInvoceToIdDiscrp As Integer, aintInvoceToDiscType As Integer, aintInvoceToIdStorage As Integer, aintInvoceToStoraType As Integer, intExporterEntityId As Integer, intExporterType As Integer) As ClsAdviceResult
        ...
        Dim lint_operation As Integer = 0
        Dim lparamGeneric As OleDbParameter = New OleDbParameter()
        Dim lobj_Advicereturn As ClsAdviceResult = New ClsAdviceResult()
        Dim lstr_SQL As String
        Dim lstr_Message As String = ""
        Dim lint_itemscount As Integer = 0
        ...
        'quitar espacios 
        lobj_Advicereturn.iint_AdviceId = 0
        lobj_Advicereturn.iint_Succes = 0
        lobj_Advicereturn.istrKeyToken = ""
        lobj_Advicereturn.istr_Container = ""
        lobj_Advicereturn.istr_Message = ""

        ''

        astr_BookingId = astr_BookingId.Trim()
        ioleconx_conexion.ConnectionString = istr_conx
        iolecmd_comand = ioleconx_conexion.CreateCommand()
        iolecmd_comand.CommandTimeout = 0
        lint_itemscount = lint_itemscount + 1
        ...
        iolecmd_comand.Parameters("@lintInvoceToIdDiscrp").Value = aintInvoceToIdDiscrp
        iolecmd_comand.Parameters("@lintInvoceToDiscType").Value = aintInvoceToDiscType
        ...
        Catch ex As Exception
            ...
            If lstr_Message.Length > 0 Then
                'Return lstr_Message
                lobj_Advicereturn.istr_Message = lstr_Message
                Return lobj_Advicereturn

            Else

                'Return ex.Message
                lobj_Advicereturn.istr_Message = ex.Message
                Return lobj_Advicereturn
        ...
        '' ver si la tabla trajo informacion 
        Try
            lobj_Advicereturn.iint_AdviceId = Integer.Parse(ldt_TableResult(0)(0).ToString)
            lobj_Advicereturn.istrKeyToken = ldt_TableResult(0)(1).ToString
        ...
        Catch ex As Exception
            ...
            'Return "error al actualizar informacion "
            lobj_Advicereturn.istr_Message = lstr_ex
            Return lobj_Advicereturn
        End Try
    ...
    Public Function of_saveDetailAdvice(ByVal aint_AdviceBooking As Integer, ByVal alistobj_container As ClsAdviceDetailDataBooking(), ByVal astr_user As String, ByVal astr_KeyToken As String) As List(Of ClsAdviceResult) ' As ClsAdviceResult() ' As DataTable
        ...
        For lint_idx = 0 To alistobj_container.Count - 1
            ...
            Try
                ...
                lobj_resultstruct(lint_idx).istrKeyToken = astr_KeyToken
                lobj_ResultITem = New ClsAdviceResult
                ...
                Catch ex As Exception
                    ...
                    lobj_ResultITem.istrKeyToken = astr_KeyToken
                    llist_return.Add(lobj_ResultITem)
                    Continue For
    ...
    Public Function of_ValidateMasterAdvice(ByVal aint_BookingAdviceId As Integer, ByVal astr_BookingId As String, ByVal aint_VesselId As Integer, ByVal alng_VesselVoyageId As Long, ByVal astr_PortId As String, ByVal astr_ETAtDate As String, ByVal aint_CustomBrokerId As Integer, ByVal aint_ShippingLine As Integer, ByVal aint_ProductId As Integer, ByVal aint_IMOCode As Integer, ByVal aint_UNCode As Integer, ByVal astr_ServiceType As String, ByVal astr_AdviceComs As String, ByVal astr_User As String) As String
        ...
        iolecmd_comand.Parameters("@lintInvoceToIdDiscrp").Value = 0
        iolecmd_comand.Parameters("@lintInvoceToDiscType").Value = 0
        iolecmd_comand.Parameters("@lintInvoceToIdStorage").Value = 0
    ...
    Public Function UpdateContainerAdviceV(ByVal aint_AdviceBooking As Integer, ByVal astr_container As String, ByVal aint_ContainerType As Integer, ByVal aint_ContainerSize As Integer, ByVal aint_ContainerISOode As Integer, ByVal aint_ShippingLine As Integer, ByVal adec_VGM As Decimal, ByVal aint_Full As Integer, ByVal astr_ValidStatus As String, ByVal astr_user As String, ByVal astr_sealnumber As String, ByVal adec_NETWeight As Decimal, ByVal astr_WeigherId As String, ByVal aint_IMOCode As Integer, ByVal aint_blnApplyIMO As Integer, ByVal aint_blnApplyUN As Integer) As String
        ...
        If aint_IMOCode > 0 Then
            ...
            Try
                ...
                lstr_masterresult = of_UpdateMasterAdviceV(aint_AdviceBooking, "", -1, -1, "", "19000101 00:00", -1, -1, -1, -1, aint_IMOCode, 0, "", "", "IGNOREST", astr_user, -1, 0, 0, 0, 0, 0, 0)
    ...
    <WebMethod()>
    Public Function GetBookingKeyToken(ByVal ainAdviceId As Integer) As String
        ...
        iolecmd_comand.Parameters.Add("@aint_AdviceId", OleDbType.Integer)
        iolecmd_comand.Parameters("@aint_AdviceId").Value = ainAdviceId

        iolecmd_comand.Parameters.Add("@strBooking", OleDbType.Char)
        iolecmd_comand.Parameters("@strBooking").Value = ""

        iolecmd_comand.Parameters.Add("@intOption", OleDbType.Integer)
        iolecmd_comand.Parameters("@intOption").Value = 2
        ...
        Try
            ...
            istr_key = idt_result(0)(0).ToString()
            Return istr_key
        Catch ex As Exception
            Dim strError As String
            strError = ObtenerError(ex.Message, 99999)
    ...
    <WebMethod()>
    Public Function GetShippingLineByName(ByVal astrShippingName As String, ByVal intConsigmentId As Integer) As DataTable
        ...
        ''validar el valor del puerto 
        astrShippingName = astrShippingName.Trim.ToUpper()
        ...
        'astrShippingName
        iolecmd_comand.Parameters.Add("@strLineName", OleDbType.Char)
        iolecmd_comand.Parameters("@strLineName").Value = astrShippingName

        ' consignataria
        iolecmd_comand.Parameters.Add("@intConsigmentId", OleDbType.Integer)
        iolecmd_comand.Parameters("@intConsigmentId").Value = intConsigmentId

        '''' -parametros del sp 
        ''''''''''''-- fin lista parametros del sp 
        'definir la cadena sql
        strSQL = "spGetShippingLineWB"
    ...
    Public Function of_GetVesselVPort(ByVal intMode As Integer, ByVal intVesselIdlong As Long, ByVal strPort As String, ByVal intVesselVoyagelong As Long, ByVal strVessel As String) As DataTable
        ...
        strVessel = strVessel.ToUpper()


        'Dim strcontainerid As String

        idt_result = New DataTable("Result")
        strSQL = "spGetVesselVPortMod"

        iolecmd_comand.Parameters.Add("@intMode", OleDbType.Integer)
        iolecmd_comand.Parameters("@intMode").Value = intMode


        iolecmd_comand.Parameters.Add("@intVesselId", OleDbType.Numeric)
        iolecmd_comand.Parameters("@intVesselId").Value = intVesselIdlong

        iolecmd_comand.Parameters.Add("@strPort", OleDbType.VarChar)
        iolecmd_comand.Parameters("@strPort").Value = strPort

        iolecmd_comand.Parameters.Add("@intVesselVoyage", OleDbType.Numeric)
        iolecmd_comand.Parameters("@intVesselVoyage").Value = intVesselVoyagelong

        iolecmd_comand.Parameters.Add("@strVessel", OleDbType.VarChar)
        iolecmd_comand.Parameters("@strVessel").Value = strVessel
    ...
    Public Function SaveDetailAdviceCustomer(ByVal aint_iintAdviceId As Integer, ByVal acontainers_list As ClsAdviceDetailDataBooking(), ByVal astr_userId As String) As List(Of ClsAdviceResult) ' As ClsAdviceResult() 'As DataTable
        ...
        If acontainers_list IsNot Nothing Then
            ...
            If acontainers_list.Count > 0 And aint_iintAdviceId > 0 Then
                ...
                lstr_keytoken = GetBookingKeyToken(aint_iintAdviceId)

                'ldtb_TableResult = of_saveDetailAdvice(aint_iintAdviceId, acontainers_list, astr_userId)
                llist_returncall = of_saveDetailAdvice(aint_iintAdviceId, acontainers_list, astr_userId, lstr_keytoken)
...
"         ( ( tblclsGeneralCargoTransaction.intGeneralCargoUniversalId = " + along_UniversalD.ToString() + " ) ) "
    ...
    ''
    <WebMethod()>
    Public Function GetVesselByName(ByVal astr_vesselName As String) As DataTable

        Dim ldtb_Result = New DataTable("userresult") ' la tabla que obtiene el resultado

        ldtb_Result = of_GetVesselVPort(1, 0, "", 0, astr_vesselName)
    ...
    <WebMethod()>
    Public Function GetPortFromVesel(ByVal astr_PortName As String, ByVal aint_VeselIdLong As Long) As DataTable

        Dim ldtb_Result = New DataTable("userresult") ' la tabla que obtiene el resultado

        ldtb_Result = of_GetVesselVPort(2, aint_VeselIdLong, astr_PortName, 0, "")
    ...
    '--
    <WebMethod()>
    Public Function GetRptVisitContListCheckIn(ByVal adtm_date As Date) As DataTable
        Dim ldtb_Result = New DataTable() ' la tabla que obtiene el resultado
        Dim iAdapt_comand As OleDbDataAdapter = New OleDbDataAdapter()
        Dim iolecmd_comand As OleDbCommand = New OleDbCommand()
        Dim ioleconx_conexion As OleDbConnection = New OleDbConnection() '' objeto de conexion que se usara para conectar 
        ...
        Dim ldtb_DateCheck As DataTable
        Dim ldtb_ReturnTable = New DataTable()
        ldtb_ReturnTable = New DataTable("ResultTable")

        istr_conx = ConfigurationManager.ConnectionStrings("dbCalathus").ToString()
        ioleconx_conexion.ConnectionString = istr_conx
        iolecmd_comand = ioleconx_conexion.CreateCommand()

        ldtb_Result = New DataTable("ResultTable")
        strSQL = "spRptVisitContListCheckIn"

        'obtener el valor de la fecha 
        lstr_dateStart = of_ConvertDateToStringGeneralFormat(adtm_date)

        iolecmd_comand.Parameters.Add("dtmStartDate", OleDbType.VarChar)
        iolecmd_comand.Parameters("dtmStartDate").Value = lstr_dateStart

        iolecmd_comand.Parameters.Add("dtmEndDate", OleDbType.VarChar)
        iolecmd_comand.Parameters("dtmEndDate").Value = lstr_dateStart
        ...
        iolecmd_comand.Parameters.Add("strParam", OleDbType.VarChar)
        iolecmd_comand.Parameters("strParam").Value = ""
